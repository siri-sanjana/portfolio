// SplashCursor WebGL Fluid Simulation (Vanilla JS)
// Based on React Bits implementation

function initSplashCursor(canvasId, options = {}) {
    console.log('initSplashCursor called for canvas', canvasId);
    ...
    let config = {
        ...
        RAINBOW_MODE: options.RAINBOW_MODE !== undefined ? options.RAINBOW_MODE : true,
    ...
    const PALETTE = ['#14213d', '#fca311', '#e5e5e5', '#ffffff'];
